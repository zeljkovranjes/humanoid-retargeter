...
{
    /// <summary>
    /// Provides the base class for HumanoidRetargeterZstd <see cref="SafeHandle"/> implementations.
    /// </summary>
    /// <remarks>
    /// Even though HumanoidRetargeterZstd is a managed library, its internals are using unmanaged
