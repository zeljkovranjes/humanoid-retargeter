...
namespace HumanoidRetargeterVrf.Serialization.KeyValues
{
    ...
    public static class KVObjectExtensions
    {
        ...
        /// <summary>
        /// Converts the key-value object to a global::System.Numerics.Vector2.
        /// </summary>
        public static global::System.Numerics.Vector2 ToVector2(this KVObject collection) => new(
            collection.GetFloatProperty("0"),
            collection.GetFloatProperty("1"));

        /// <summary>
        /// Converts the key-value object to a global::System.Numerics.Vector3.
        /// </summary>
        public static global::System.Numerics.Vector3 ToVector3(this KVObject collection) => new(
            collection.GetFloatProperty("0"),
            collection.GetFloatProperty("1"),
            collection.GetFloatProperty("2"));

        /// <summary>
        /// Converts the key-value object to a global::System.Numerics.Vector4.
        /// </summary>
        public static global::System.Numerics.Vector4 ToVector4(this KVObject collection) => new(
            collection.GetFloatProperty("0"),
            collection.GetFloatProperty("1"),
            collection.GetFloatProperty("2"),
        ...
        /// <summary>
        /// Converts the key-value object to a global::System.Numerics.Quaternion.
        /// </summary>
        public static global::System.Numerics.Quaternion ToQuaternion(this KVObject collection) => new(
            collection.GetFloatProperty("0"),
            collection.GetFloatProperty("1"),
            collection.GetFloatProperty("2"),
            collection.GetFloatProperty("3"));
        ...
        /// <summary>
        /// Converts an array of key-value objects to a global::System.Numerics.Matrix4x4.
        /// </summary>
        public static global::System.Numerics.Matrix4x4 ToMatrix4x4(this KVObject[] array)
        {
            var column1 = array[0].ToVector4();
            var column2 = array[1].ToVector4();
            var column3 = array[2].ToVector4();
            var column4 = array.Length > 3 ? array[3].ToVector4() : new global::System.Numerics.Vector4(0, 0, 0, 1);

            return new global::System.Numerics.Matrix4x4(column1.X, column2.X, column3.X, column4.X, column1.Y, column2.Y, column3.Y, column4.Y, column1.Z, column2.Z, column3.Z, column4.Z, column1.W, column2.W, column3.W, column4.W);
        }

        /// <summary>
        /// Converts the key-value object to a global::System.Numerics.Matrix4x4.
        /// </summary>
        public static global::System.Numerics.Matrix4x4 ToMatrix4x4(this KVObject array)
        {
            var column4 = array.Count > 12
                ? new global::System.Numerics.Vector4(array.GetFloatProperty("12"), array.GetFloatProperty("13"), array.GetFloatProperty("14"), array.GetFloatProperty("15"))
                : new global::System.Numerics.Vector4(0, 0, 0, 1);
