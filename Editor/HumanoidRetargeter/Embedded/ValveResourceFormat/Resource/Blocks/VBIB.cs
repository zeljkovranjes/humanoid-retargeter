...
#pragma warning restore CA1051 // Do not declare visible instance fields
        ...
        private static byte[] DecompressData(OnDiskBufferData buffer, Span<byte> span, int decompressedSize, bool isVertex, bool isZstdCompressed)
        {
            ...
            try
            {
                if (isZstdCompressed)
                {
                    using var zstdDecompressor = new HumanoidRetargeterZstd.Decompressor();
        ...
        */
        ...
        /// </summary>
        public static global::System.Numerics.Vector2[] GetVector2AttributeArray(OnDiskBufferData vertexBuffer, RenderInputLayoutField attribute)
        {
            var result = new global::System.Numerics.Vector2[vertexBuffer.ElementCount];
                ...
                case DXGI_FORMAT.R16G16_FLOAT:
                    {
                        for (var i = 0; i < vertexBuffer.ElementCount; i++)
                        {
                            ...
                            result[i] = new global::System.Numerics.Vector2((float)halfs[0], (float)halfs[1]);
                ...
                case DXGI_FORMAT.R16G16_UNORM:
                    {
                        for (var i = 0; i < vertexBuffer.ElementCount; i++)
                        {
                            ...
                            result[i] = new global::System.Numerics.Vector2(ushorts[0], ushorts[1]) / 65535f;
                ...
                case DXGI_FORMAT.R16G16_SNORM:
                    {
                        for (var i = 0; i < vertexBuffer.ElementCount; i++)
                        {
                            ...
                            result[i] = new global::System.Numerics.Vector2(shorts[0], shorts[1]) / 32767f;
        ...
        /// </summary>
        public static global::System.Numerics.Vector3[] GetVector3AttributeArray(OnDiskBufferData vertexBuffer, RenderInputLayoutField attribute)
        {
            ...
            var result = new global::System.Numerics.Vector3[vertexBuffer.ElementCount];
        ...
        /// </summary>
        public static global::System.Numerics.Vector4[] GetVector4AttributeArray(OnDiskBufferData vertexBuffer, RenderInputLayoutField attribute)
        {
            var result = new global::System.Numerics.Vector4[vertexBuffer.ElementCount];
                ...
                case DXGI_FORMAT.R16G16B16A16_FLOAT:
                    {
                        for (var i = 0; i < vertexBuffer.ElementCount; i++)
                        {
                            ...
                            result[i] = new global::System.Numerics.Vector4(
                                (float)halfs[0],
                                (float)halfs[1],
                                (float)halfs[2],
                                (float)halfs[3]
        ...
        /// </summary>
        public static (global::System.Numerics.Vector3[] Normals, global::System.Numerics.Vector4[] Tangents) GetNormalTangentArray(OnDiskBufferData vertexBuffer, RenderInputLayoutField attribute)
        {
            if (attribute.Format == DXGI_FORMAT.R10G10B10A2_UNORM)
            {
                // Current s&box stores an octahedral normal in the first two 10-bit
                // channels. Let ModelDoc regenerate the tangent basis from the UVs.
                var packed = new uint[vertexBuffer.ElementCount];
                MarshallAttributeArray(packed, sizeof(uint), vertexBuffer, attribute);
                var normals = new global::System.Numerics.Vector3[packed.Length];
                for (var i = 0; i < packed.Length; i++)
                {
                    var x = (packed[i] & 1023) / 511.5f - 1;
                    var y = ((packed[i] >> 10) & 1023) / 511.5f - 1;
                    var normal = new global::System.Numerics.Vector3(x, y, 1 - MathF.Abs(x) - MathF.Abs(y));
                    var fold = Math.Clamp(-normal.Z, 0, 1);
                    normal.X -= MathF.CopySign(fold, x);
                    normal.Y -= MathF.CopySign(fold, y);
                    normals[i] = global::System.Numerics.Vector3.Normalize(normal);
                }
                return (normals, Array.Empty<global::System.Numerics.Vector4>());
            }
            if (attribute.Format == DXGI_FORMAT.R32G32B32_FLOAT)
            {
                var normals = new global::System.Numerics.Vector3[vertexBuffer.ElementCount];
            ...
            {
                var normals = new global::System.Numerics.Vector3[vertexBuffer.ElementCount];
                var tangents = new global::System.Numerics.Vector4[vertexBuffer.ElementCount];
                var offset = (int)attribute.Offset;
        ...
        /// </summary>
        public static global::System.Numerics.Vector4[] GetBlendWeightsArray(OnDiskBufferData vertexBuffer, RenderInputLayoutField attribute)
        {
            var numVectors = attribute.Format is DXGI_FORMAT.R16G16B16A16_UNORM ? 2 : 1;
            var weights = new global::System.Numerics.Vector4[vertexBuffer.ElementCount * numVectors];
                ...
                case DXGI_FORMAT.R8G8B8A8_UNORM:
                    {
                        ...
                        {
                            weights[i] = new global::System.Numerics.Vector4(
                                data[offset],
                                data[offset + 1],
                                data[offset + 2],
                                data[offset + 3]
                ...
                case DXGI_FORMAT.R16G16B16A16_UNORM:
                    {
                        ...
                        {
                            weights[i] = new global::System.Numerics.Vector4(data[offset], data[offset + 1], data[offset + 2], data[offset + 3]) / 255f;
                            weights[i + 1] = new global::System.Numerics.Vector4(data[offset + 4], data[offset + 5], data[offset + 6], data[offset + 7]) / 255f;
        ...
        private static global::System.Numerics.Vector3 DecompressNormal(float x, float y)
        {
            var outputNormal = global::System.Numerics.Vector3.Zero;
        ...
        private static global::System.Numerics.Vector4 DecompressTangent(float x, float y)
        {
            var outputNormal = DecompressNormal(x, y);
            var tSign = y < 128.0f ? -1.0f : 1.0f;

            return new global::System.Numerics.Vector4(outputNormal.X, outputNormal.Y, outputNormal.Z, tSign);
        }

        private static (global::System.Numerics.Vector3[] Normals, global::System.Numerics.Vector4[] Tangents) DecompressNormalTangents2(uint[] packedFrames)
        {
            var normals = new global::System.Numerics.Vector3[packedFrames.Length];
            var tangents = new global::System.Numerics.Vector4[packedFrames.Length];
            ...
            for (var i = 0; i < packedFrames.Length; i++)
            {
                ...
                var unpackedNormal = new global::System.Numerics.Vector3(nPackedFrameX, nPackedFrameY, derivedNormalZ);
                ...
                var normal = global::System.Numerics.Vector3.Normalize(unpackedNormal); // Get final normal by normalizing it onto the unit sphere
                normals[i] = normal;
                ...
                global::System.Numerics.Vector3 unalignedTangent;
                ...
                var tangent = unalignedTangent * MathF.Cos(nPackedFrameT) + global::System.Numerics.Vector3.Cross(normal, unalignedTangent) * MathF.Sin(nPackedFrameT);

                tangents[i] = new global::System.Numerics.Vector4(tangent, (SignBit == 0u) ? -1.0f : 1.0f); // Bitangent sign bit... inverted (0 = negative
            }
