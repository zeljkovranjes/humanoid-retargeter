...
namespace HumanoidRetargeterVrf.ResourceTypes.ModelData.Attachments
{
    /// <summary>
    ...
    public class Attachment : IEnumerable<Attachment.Influence>
    {
        ...
        public readonly struct Influence
        {
            ...
            /// </summary>
            public global::System.Numerics.Vector3 Offset { get; init; }

            /// <summary>
            /// Gets the rotation of the influence.
            /// </summary>
            public global::System.Numerics.Quaternion Rotation { get; init; }
