    ...
    public class AnimationFrameCache
    {
        ...
        public Frame GetInterpolatedFrame(Animation anim, float time)
        {
            ...
            for (var i = 0; i < frame1.Bones.Length; i++)
            {
                ...
                InterpolatedFrame.Bones[i].Position = global::System.Numerics.Vector3.Lerp(frame1Bone.Position, frame2Bone.Position, t);
                InterpolatedFrame.Bones[i].Angle = global::System.Numerics.Quaternion.Slerp(frame1Bone.Angle, frame2Bone.Angle, t);
            ...
            if (anim.HasMovementData())
            {
                InterpolatedFrame.Movement = new(
                    global::System.Numerics.Vector3.Lerp(frame1.Movement.Position, frame2.Movement.Position, t),
