...
{
    /// <summary>
    /// Decodes delta-compressed global::System.Numerics.Vector3 animation data with a base value and half-precision deltas.
    /// </summary>
    public class CCompressedDeltaVector3 : AnimationSegmentDecoder
    {
        /// <inheritdoc/>
        /// <remarks>
        /// Reads a base global::System.Numerics.Vector3 and adds a half-precision delta to produce the final value.
        /// </remarks>
        public override void Read(int frameIndex, Frame outFrame)
        {
            var offset = frameIndex * ElementCount;

            const int BaseElementSize = sizeof(float) * 3; // sizeof(global::System.Numerics.Vector3)
            var baseData = MemoryMarshal.Cast<byte, global::System.Numerics.Vector3>(Data.AsSpan(0, ElementCount * BaseElementSize));
